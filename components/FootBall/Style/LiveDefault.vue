    ...
    <div class="live_-match">
        <div class="live-match-Jbo1mR live-match">
            ...
            <div class="score-AKR3e5 score">
                <img class="vector-eyBPRK vector" src="~/public/img/vector-27@2x.png" alt="Vector" />
                <img class="vector-n1oFur vector" src="~/public/img/vector-28@2x.png" alt="Vector" />
                <img class="vector-z3kuGS vector" src="~/public/img/vector-29@2x.png" alt="Vector" />
        ...
        <div class="live-tracker">
            <a href="javascript:;" @click="props.goLiveTracker()">
                <img class="btn_-live-tracker" src="~/public/img/btn-livetracker-9@2x.png" alt="Btn_LiveTracker" />
            </a>
        </div>
    </div>
</template>
